...
SELECT EMP_NAME,SALARY ,BONUS FROM EMPLOYEE2 e WHERE EMP_NAME IN ('유재식','방명수')
...
DELETE FROM EMPLOYEE2 e ; --> WHERE절 미작성 시 전체 삭제

SELECT * FROM EMPLOYEE2 e ; --> 24행 삭제
