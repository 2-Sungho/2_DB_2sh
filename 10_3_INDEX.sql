...
SELECT * FROM EMPLOYEE WHERE EMP_ID=215; -- 인덱스 사용O
SELECT * FROM EMPLOYEE WHERE EMP_NAME='대북혼'; -- 인덱스 사용O
...
WHERE TEST_ID='TEST500000'; -- INDEX사용 X
--> 15ms

SELECT * FROM TB_IDX_TEST
WHERE TEST_NO=500000; -- INDEX사용 O 
--> 0~1ms